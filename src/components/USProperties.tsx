...
const USProperties = ({ data = [] }: USPropertiesProps) => {
  ...
  const propertyTypes = ['All', 'Office', 'Hotel', 'Industrial', 'Retail', 'Mixed-Use'];
  ...
  return (
    <div className="min-h-screen bg-[#05070a] text-white font-light selection:bg-amber-500/30">
      ...
      {/* TOOLBAR - Fixed position to prevent overlap */}
      ...
      {/* REGULATORY SECTION */}
      <section className="bg-white/5 border-y border-white/10 py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-6 md:px-8">
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-8 md:gap-16">
            <div className="space-y-4 md:space-y-6">
              ...
              <h4 className="text-lg md:text-xl font-serif italic">SEC Compliance</h4>
            ...
            <div className="space-y-4 md:space-y-6">
              ...
              <h4 className="text-lg md:text-xl font-serif italic">1031 Exchange</h4>
            ...
            <div className="space-y-4 md:space-y-6">
              ...
              <h4 className="text-lg md:text-xl font-serif italic">CREFC Standards</h4>
