...
const blog: Blog[] =[
  ...
  },
  {
    ...
    excerpt: 'Learn the essential steps for evaluating, financing, and purchasing commercial real estate with confidence. A comprehensive guide covering market fundamentals, financing options, and negotiation strategies.',
    author: 'LoopNet Team',
    category: 'Investing',
  ...
  },
  {
    ...
    excerpt: 'A REIT allows individual investors to buy shares in a company that owns and manages income-producing real estate. Learn what you need to know before investing in a REIT.',
    author: 'LoopNet Team',
    category: 'Investing',
    date: 'August 25, 2025',
    readTime: '9 min read',
  ...
  },
  {
    ...
    title: 'How to Buy a Duplex: Comprehensive Insights for Successful Investment',
    excerpt: 'Breaking down every stage of buying a duplex, from budgeting and financing to agent selection and market analysis, ensuring you make an informed investment decision.',
    author: 'LoopNet Team',
    category: 'Investing',
    date: 'October 24, 2025',
    readTime: '15 min read',
    image: 'https://www.loopnet.com/s/images/delete1/classic-duplex-home-front-exterior-boston-street.webp',
    featured: false,
  },
  {
    id: 'what-is-a-1031-exchange',
    title: 'What is a 1031 Exchange? Understanding Tax-Deferred Real Estate Transactions',
    excerpt: 'A 1031 exchange is a tax strategy used by real estate investors to defer paying capital gains taxes. Learn how to reinvest proceeds and defer taxes on the sale of an investment property.',
    author: 'LoopNet Team',
    category: 'Finance',
    date: 'September 12, 2025',
    readTime: '11 min read',
    image: 'https://www.loopnet.com/s/images/what-is-a-1031-exchange/1031-exchange-time-constraints.webp',
    featured: false,
  },
  {
    id: 'understanding-the-triple-net-lease',
    title: 'Understanding the Triple Net Lease: A Guide to NNN Leases',
    excerpt: 'A guide explaining the meaning of NNN, and how it impacts lease agreements for tenants and landlords in commercial real estate.',
    author: 'LoopNet Team',
    category: 'Finance',
    date: 'June 20, 2025',
    readTime: '8 min read',
    image: 'https://www.loopnet.com/s/images/understanding-the-triple-net-lease/key-elements-of-a-triple-net-lease.webp',
    featured: false,
  },
  {
    id: 'duplex-vs-triplex-vs-fourplex',
    title: 'Duplex vs. Triplex vs. Fourplex Comparison for Real Estate Investors',
    excerpt: 'Compare financing options, management requirements, and risk factors across 2-4 unit properties to choose the right investment for your goals.',
    author: 'LoopNet Team',
    category: 'Investing',
  ...
  {
    id: 'how-to-buy-land',
    title: 'How to Buy Land: Is Buying Land a Good Investment?',
    excerpt: 'Understanding the buying process for land investment. Learn key considerations, financing options, and evaluation strategies for purchasing land.',
    author: 'LoopNet Team',
    category: 'Investing',
    date: 'August 15, 2025',
    readTime: '11 min read',
  ...
  {
    id: 'duplex-investing-guide',
    title: 'Duplex Investing Guide: Financing, Analysis, & Risk Management',
    excerpt: 'Duplex investing offers dual rental income, lower vacancy risk, and flexible financing. Explore how to analyze, finance, and manage duplex properties to build long-term wealth.',
    author: 'LoopNet Team',
    category: 'Investing',
  ...
  {
    id: 'what-is-a-multifamily-home',
    title: 'What is a Multifamily Home? Definition, Types, and Investment Guide',
    excerpt: 'Clear definition, types, how small assets differ from large for financing, metrics, plus basics of zoning, fair housing, and risks.',
    author: 'LoopNet Team',
    category: 'Investing',
    date: 'July 20, 2025',
    readTime: '9 min read',
  ...
  {
    id: 'multifamily-exit-strategies',
    title: 'Multifamily Exit Strategies: Timing and Execution for Profitable Exits',
    excerpt: 'A data-driven framework for selecting, timing, and executing profitable exits in today\'s multifamily market.',
    author: 'LoopNet Team',
    category: 'Investing',
    date: 'August 10, 2025',
    readTime: '10 min read',
  ...
  {
    id: 'understanding-land-values',
    title: 'An Investor\'s Guide to Understanding Land Values',
    excerpt: 'Supply and demand are key drivers when it comes to land valuation. Learn how to evaluate land values for investment purposes.',
    author: 'LoopNet Team',
    category: 'Investing',
    date: 'July 5, 2025',
    readTime: '8 min read',
    image: 'https://images.pexels.com/photos/2360673/pexels-photo-2360673.jpeg?auto=compress&cs=tinysrgb&w=1200',
    featured: false,
  },
  {
    id: 'yield-on-cost',
    title: 'Yield on Cost: Measuring Property Performance in Real Estate',
    excerpt: 'Detailing how yield on cost measures property performance by comparing stabilized NOI to total project costs, and it highlights complementary metrics for smarter investment decisions.',
    author: 'LoopNet Team',
    category: 'Investing',
    date: 'June 15, 2025',
    readTime: '7 min read',
  ...
  },
  {
    ...
    title: 'Discounted Cash Flow: DCF Analysis for Real Estate Investment',
    excerpt: 'Breaking down DCF fundamentals, models, and decision-making frameworks to help investors accurately assess property value.',
    author: 'LoopNet Team',
    category: 'Investing',
    date: 'May 30, 2025',
    readTime: '12 min read',
  ...
  {
    id: 'rate-of-return-in-cre',
    title: 'Rate of Return in Commercial Real Estate: Calculation and Optimization',
    excerpt: 'Master the fundamentals of rate of return, from simple calculations to advanced metrics like IRR and DCF, and learn how to benchmark and optimize your commercial real estate investments.',
    author: 'LoopNet Team',
    category: 'Investing',
    date: 'May 15, 2025',
    readTime: '10 min read',
  ...
  },
  {
    ...
    title: 'Internal Rate of Return (IRR): Understanding IRR in Real Estate',
    excerpt: 'Clarifying IRR concepts, outlines calculation methods, and examining its application in commercial real estate to guide your investment decisions.',
    author: 'LoopNet Team',
    category: 'Investing',
    date: 'May 1, 2025',
    readTime: '9 min read',
  ...
  },
  {
    ...
    title: 'Small vs. Large Multifamily Real Estate Investing',
    excerpt: 'Compare financing, cash flow, risk, and exit options so you can choose the right property size for your goals.',
    author: 'LoopNet Team',
    category: 'Investing',
    date: 'April 20, 2025',
    readTime: '11 min read',
  ...
  {
    id: 'what-is-an-adu',
    title: 'What is an ADU? Accessory Dwelling Units and Investment Properties',
    excerpt: 'Practical insights on ADU design, financing, and regulations to help investors maximize property value and income potential.',
    author: 'LoopNet Team',
    category: 'Investing',
    date: 'April 5, 2025',
    readTime: '8 min read',
  ...
  {
    id: 'what-is-an-investment-property',
    title: 'What is an Investment Property? Strategies and Financial Tools',
    excerpt: 'Providing clear definitions, actionable strategies, and key financial tools to help you make informed decisions in real estate investing.',
    author: 'LoopNet Team',
    category: 'Investing',
    date: 'March 25, 2025',
    readTime: '10 min read',
  ...
  {
    id: 'grant-deed-essentials',
    title: 'Grant Deed Essentials: Legal Structure in Commercial Real Estate',
    excerpt: 'A comprehensive guide detailing the legal structure, requirements, and strategic use of grant deeds in commercial real estate.',
    author: 'LoopNet Team',
    category: 'Investing',
    date: 'March 10, 2025',
    readTime: '7 min read',
  ...
  {
    id: 'quitclaim-deed',
    title: 'Quitclaim Deed Explained: Definition, Purpose, and Applications',
    excerpt: 'Detailing the definition, purpose, legal requirements, risks, and strategic applications of a quitclaim deed for both personal and commercial real estate transactions.',
    author: 'LoopNet Team',
    category: 'Investing',
  ...
  {
    id: 'benefits-challenges-multifamily-investing',
    title: 'Benefits and Challenges of Multifamily Investing',
    excerpt: 'A practical, data driven guide outlining key advantages, market performance data, and actionable strategies to overcome common multifamily investment hurdles.',
    author: 'LoopNet Team',
    category: 'Investing',
  ...
  {
    id: 'how-to-find-good-tenants',
    title: 'How to Find Good Tenants for Your Apartment Complex',
    excerpt: 'Strategies to attract, screen, and retain quality residents for your apartment complex.',
    author: 'LoopNet Team',
    category: 'Investing',
  ...
  {
    id: 'how-to-buy-a-multifamily-property',
    title: 'How to Buy a Multifamily Property: Complete Investment Guide',
    excerpt: 'A data driven framework for evaluating, financing, and managing multifamily investments, from initial planning through successful operation.',
    author: 'LoopNet Team',
    category: 'Investing',
  ...
  {
    id: 'multifamily-investing-101',
    title: 'Multifamily Investing 101: Essential Strategies and Management',
    excerpt: 'A practical, end to end blueprint outlining essential strategies, financial metrics, and management techniques for successful multifamily investing.',
    author: 'LoopNet Team',
    category: 'Investing',
  ...
  {
    id: 'what-is-an-encumbrance',
    title: 'What Is an Encumbrance? Types and Impact on Property Value',
    excerpt: 'Understand the types of encumbrances that affect property value, use, and exit strategy and how to navigate them as an investor.',
    author: 'LoopNet Team',
    category: 'Investing',
  ...
  },
  {
    ...
    title: 'What is Improved Land? Understanding Improved vs. Unimproved Land',
    excerpt: 'Understanding the differences between improved and unimproved land for real estate investment.',
    author: 'LoopNet Team',
    category: 'Investing',
  ...
  {
    id: 'exit-cap-rates',
    title: 'Exit Cap Rates in Commercial Real Estate Investment',
    excerpt: 'Understanding Exit Cap Rates and Terminal Cap Rates for Better Investment Returns.',
    author: 'LoopNet Team',
    category: 'Investing',
  ...
  {
    id: 'sales-comparison-approach',
    title: 'Sales Comparison Approach: Property Valuation Method',
    excerpt: 'Learn how to use market data to make confident property investment decisions.',
    author: 'LoopNet Team',
    category: 'Investing',
  ...
  },
  {
    ...
    title: 'Understanding Tenancy in Common in Real Estate',
    excerpt: 'The structure, benefits, and challenges of tenancy in common, offering actionable insights for commercial real estate investors.',
    author: 'LoopNet Team',
    category: 'Investing',
  ...
  {
    id: 'warranty-deed',
    title: 'Warranty Deed: Understanding Real Estate Title Protection',
    excerpt: 'A warranty deed shifts title risk from buyer to seller, this guide explains how it works, where it falls short, and how to negotiate stronger protections in commercial transactions.',
    author: 'LoopNet Team',
    category: 'Investing',
  ...
  },
  {
    ...
    title: 'Pros and Cons of Buying Land for Investment',
    excerpt: 'Evaluating the benefits and challenges of land ownership for investment purposes.',
    author: 'LoopNet Team',
    category: 'Investing',
  ...
  {
    id: 'understanding-dscr',
    title: 'Debt Service Coverage Ratio (DSCR) in Real Estate Investing',
    excerpt: 'Learn how to calculate, interpret, and improve your Debt Service Coverage Ratio to make informed real estate investment decisions.',
    author: 'LoopNet Team',
    category: 'Investing',
    date: 'August 28, 2024',
    readTime: '8 min read',
  ...
  {
    id: 'hotel-innovation',
    title: 'Hotel Innovation for Owners: Drive Revenue Growth',
    excerpt: 'Unlock new opportunities and drive revenue growth with hotel innovation strategies.',
    author: 'LoopNet Team',
    category: 'Investing',
    date: 'August 15, 2024',
    readTime: '11 min read',
  ...
  },
  {
    ...
    title: 'How to Buy a Retail Property: Investment Guide',
    excerpt: 'Learn the essential steps to evaluate, finance, and purchase retail investment properties with confidence.',
    author: 'LoopNet Team',
    category: 'Investing',
    date: 'July 30, 2024',
    readTime: '12 min read',
  ...
  {
    id: 'what-is-title-insurance',
    title: 'What is Title Insurance? Protecting Your Real Estate Investment',
    excerpt: 'Essential coverage that protects commercial property investors from ownership disputes, liens, and title defects that could threaten their investment and cash flow.',
    author: 'LoopNet Team',
    category: 'Investing',
    date: 'July 15, 2024',
    readTime: '8 min read',
  ...
  },
  {
    ...
    title: 'Property Title Search: Verify Ownership and Spot Red Flags',
    excerpt: 'Learn how to verify ownership, spot red flags, and protect your deal with a thorough property title search.',
    author: 'LoopNet Team',
    category: 'Investing',
    date: 'June 30, 2024',
    readTime: '7 min read',
  ...
  {
    id: 'cam-charges',
    title: 'Common Area Maintenance Charges (CAM): Understanding Tenant Costs',
    excerpt: 'Understand CAM fees: How tenants share building operating costs in a triple net lease.',
    author: 'LoopNet Team',
    category: 'Investing',
    date: 'June 15, 2024',
    readTime: '9 min read',
  ...
  {
    id: 'land-entitlement-process',
    title: 'Land Entitlement: Identifying Risks and Mitigation Strategies',
    excerpt: 'Identifying risks and mitigation strategies for unentitled land development projects.',
    author: 'LoopNet Team',
  ...
  {
    id: 'how-to-invest-in-land',
    title: 'How to Invest in Land: A Guide for Beginners',
    excerpt: 'Investing in land for beginners: Understanding the process, benefits, and considerations.',
    author: 'LoopNet Team',
    category: 'Getting Started',
    date: 'May 15, 2024',
    readTime: '11 min read',
  ...
  {
    id: 'how-to-buy-an-apartment-complex',
    title: 'How to Buy an Apartment Complex: From Analysis to Acquisition',
    excerpt: 'Your roadmap to successful apartment building investment, from market analysis to closing.',
    author: 'LoopNet Team',
    category: 'Getting Started',
    date: 'April 30, 2024',
    readTime: '14 min read',
  ...
  },
  {
    ...
    title: 'Commercial Real Estate Terms: Essential CRE Glossary',
    excerpt: 'Understanding key CRE terms to make informed investment decisions.',
    author: 'LoopNet Team',
    category: 'Getting Started',
    date: 'April 15, 2024',
    readTime: '12 min read',
  ...
  {
    id: 'how-to-lease-office-space',
    title: 'How To Lease Office Space in 8 Steps',
    excerpt: 'How to lease your first office or move into a new one with confidence.',
    author: 'LoopNet Team',
    category: 'Getting Started',
    date: 'March 30, 2024',
    readTime: '10 min read',
    image: 'https://images.pexels.com/photos/1957478/pexels-photo-1957478.jpeg?auto=compress&cs=tinysrgb&w=1200',
    featured: false,
  },
  {
    id: 'how-to-find-coworking-space',
    title: 'How to Find Your Ideal Coworking Space',
    excerpt: 'Make an informed decision about your next workspace with these essential evaluation criteria and expert tips.',
    author: 'LoopNet Team',
    category: 'Getting Started',
    date: 'March 15, 2024',
    readTime: '8 min read',
  ...
  },
  {
    ...
    title: 'How to Buy a Hotel: Your Guide to Smart Investing',
    excerpt: 'Learn the key considerations and strategies for successful hotel ownership.',
    author: 'LoopNet Team',
    category: 'Getting Started',
  ...
  {
    id: 'maximize-coworking-space',
    title: 'How to Make the Most of Your Coworking Space',
    excerpt: 'Go beyond surface-level tips and leverage coworking spaces strategically to support and expand your business goals.',
    author: 'LoopNet Team',
    category: 'Getting Started',
  ...
  {
    id: 'how-to-buy-a-car-wash',
    title: 'How to Buy a Car Wash: Investment Guide and Strategies',
    excerpt: 'Unlock the potential of car wash investments with expert insights on types, costs, and strategies.',
    author: 'LoopNet Team',
    category: 'Getting Started',
    date: 'January 30, 2024',
    readTime: '11 min read',
    image: 'https://images.pexels.com/photos/1619799/pexels-photo-1619799.jpeg?auto=compress&cs=tinysrgb&w=1200',
    featured: false,
  },
  {
    id: 'touring-coworking-space',
    title: 'What to Look for When Touring a Coworking Space',
    excerpt: 'Learn how to evaluate coworking spaces to support your business growth and networking needs.',
    author: 'LoopNet Team',
    category: 'Getting Started',
  ...
  {
    id: 'commercial-vs-residential-investing',
    title: 'Commercial vs. Residential Real Estate Investing',
    excerpt: 'Understanding the differences, benefits, and risks of commercial and residential real estate investing.',
    author: 'LoopNet Team',
    category: 'Getting Started',
  ...
  {
    id: 'what-is-leed-certification',
    title: 'What is LEED Certification? Environmental Stewardship and Cost Savings',
    excerpt: 'Environmental stewardship with cost-saving benefits for commercial buildings.',
    author: 'LoopNet Team',
    category: 'Getting Started',
  ...
  {
    id: 'debt-yield-cre',
    title: 'Debt Yield in Commercial Real Estate: Risk Assessment',
    excerpt: 'Learn how debt yield is calculated and its role in assessing risk in CRE loans.',
    author: 'LoopNet Team',
    category: 'Finance',
  ...
  },
  {
    ...
    title: 'Multifamily Financing Options & Rates: Complete Guide',
    excerpt: 'A comprehensive overview of multifamily loan programs, current market rates, and essential requirements for successful financing in today\'s market.',
    author: 'LoopNet Team',
    category: 'Finance',
  ...
  {
    id: 'cre-loans',
    title: 'Commercial Real Estate (CRE) Loans: Options and Strategies',
    excerpt: 'Commercial real estate loans: Options and strategies for financing your property investments.',
    author: 'LoopNet Team',
    category: 'Finance',
  ...
  {
    id: 'land-loans',
    title: 'Land Loans 101: Key Considerations for Commercial Properties',
    excerpt: 'Key considerations when applying for a land loan for commercial property development.',
    author: 'LoopNet Team',
    category: 'Finance',
  ...
  },
  {
    ...
    title: 'Loan to Value (LTV): Calculation, Analysis, and Strategic Approaches',
    excerpt: 'Breaking down the loan to value concept, its calculations, and strategic financing options to enhance investment decisions in commercial real estate.',
    author: 'LoopNet Team',
    category: 'Finance',
  ...
  {
    id: 'leverage-ratio',
    title: 'Leverage Ratio Explained: Impact on Risk and Returns',
    excerpt: 'A complete guide to how leverage ratios impact risk, financing, and returns - for both investors looking to buy and those who already own commercial property.',
    author: 'LoopNet Team',
    category: 'Finance',
  ...
  {
    id: 'master-lease-strategies',
    title: 'Master Lease Strategies: Maximizing Control and Income',
    excerpt: 'Maximizing control and income with flexible leasing solutions.',
    author: 'LoopNet Team',
    category: 'Finance',
    date: 'August 30, 2023',
    readTime: '9 min read',
  ...
  {
    id: 'percentage-lease',
    title: 'Percentage Lease: Align Interests and Boost Revenue Potential',
    excerpt: 'Learn how percentage leases align interests, boost revenue potential, and adapt to modern business models.',
    author: 'LoopNet Team',
    category: 'Finance',
    date: 'August 15, 2023',
    readTime: '8 min read',
  ...
  },
  {
    ...
    title: 'Net Leases in Commercial Real Estate: In-Depth Guide',
    excerpt: 'An in-depth guide explaining the complexities of net leases for tenants and investors.',
    author: 'LoopNet Team',
    category: 'Finance',
    date: 'July 30, 2023',
    readTime: '11 min read',
  ...
  {
    id: 'absolute-net-lease',
    title: 'The Absolute Net Lease: Maximizing Investments',
    excerpt: 'Maximizing investments and streamlining real estate operations with absolute net leases.',
    author: 'LoopNet Team',
    category: 'Finance',
    date: 'July 15, 2023',
    readTime: '7 min read',
  ...
  {
    id: 'what-is-sale-leaseback',
    title: 'What Is a Sale-Leaseback? Converting Equity into Cash',
    excerpt: 'A company that operates out of a building it owns initiates a sale-leaseback to convert the equity in its real estate asset into cash.',
    author: 'LoopNet Team',
    category: 'Finance',
    date: 'June 30, 2023',
    readTime: '9 min read',
  ...
  {
    id: 'gross-lease-explained',
    title: 'Gross Lease Explained: What Investors Need to Know',
    excerpt: 'Learn the essentials of gross leases and how they compare to net leases.',
    author: 'LoopNet Team',
    category: 'Finance',
    date: 'June 15, 2023',
    readTime: '8 min read',
  ...
  },
  {
    ...
    title: 'Bonus Depreciation: Tax Strategy for Real Estate',
    excerpt: 'A practical guide to using bonus depreciation to reduce tax liability, improve cash flow, and plan property improvements with timing strategies in mind.',
    author: 'LoopNet Team',
    category: 'Finance',
    date: 'May 30, 2023',
    readTime: '10 min read',
  ...
  },
  {
    ...
    title: 'Tenant Improvement Allowance (TIA) in Commercial Real Estate',
    excerpt: 'What is a tenant improvement allowance in commercial real estate leasing?',
    author: 'LoopNet Team',
    category: 'Finance',
    date: 'May 15, 2023',
    readTime: '7 min read',
  ...
  {
    id: 'single-net-lease',
    title: 'Single Net Leases: Clear Insights for Property Owners',
    excerpt: 'Clear, actionable insights and practical comparisons to help investors and property owners navigate single net lease agreements effectively.',
    author: 'LoopNet Team',
    category: 'Finance',
    date: 'April 30, 2023',
    readTime: '6 min read',
  ...
  },
  {
    ...
    title: 'Force Majeure Clause: Understanding Lease Protections',
    excerpt: 'Understand how force majeure clauses work in commercial real estate leases, including what they cover, when they apply, and how to draft them to manage risk.',
    author: 'LoopNet Team',
    category: 'Finance',
    date: 'April 15, 2023',
    readTime: '8 min read',
  ...
  {
    id: 'what-is-721-exchange',
    title: 'What is a 721 Exchange? Defer Real Estate Taxes',
    excerpt: 'How to defer real estate taxes with a 721 exchange strategy.',
    author: 'LoopNet Team',
    category: 'Finance',
    date: 'March 30, 2023',
    readTime: '9 min read',
  ...
  },
  {
    ...
    title: 'Cash on Cash Return: Optimize Your Real Estate Investments',
    excerpt: 'Learn how cash on cash return can optimize your real estate investments and measure annual performance.',
    author: 'LoopNet Team',
    category: 'Tools',
    date: 'March 15, 2023',
    readTime: '7 min read',
  ...
  },
  {
    ...
    title: 'Gross Rent Multiplier (GRM) Calculator & Investment Guide',
    excerpt: 'Simplifying your investment analysis with the gross rent multiplier metric.',
    author: 'LoopNet Team',
    category: 'Tools',
  ...
  {
    id: 'commercial-property-valuation',
    title: 'Commercial Property Valuation: Core Methods and Value Estimator',
    excerpt: 'Understand core valuation methods, prevent mistakes, and use our instant value estimator.',
    author: 'LoopNet Team',
    category: 'Tools',
  ...
  {
    id: 'irr-calculator',
    title: 'Internal Rate of Return (IRR) Calculator for Real Estate',
    excerpt: 'Use this calculator to measure annualized returns, compare investment scenarios, and evaluate risk across commercial real estate deals.',
    author: 'LoopNet Team',
    category: 'Tools',
  ...
  },
  {
    ...
    title: 'Office Space Calculator: Estimate Team Space Needs',
    excerpt: 'Estimate how much space your team really needs for optimal productivity.',
    author: 'LoopNet Team',
    category: 'Tools',
  ...
  {
    id: 'noi-calculator',
    title: 'Net Operating Income (NOI) Calculator for Real Estate',
    excerpt: 'Calculating NOI and understanding the significance of this metric in commercial real estate investment.',
    author: 'LoopNet Team',
    category: 'Tools',
  ...
  },
  {
    ...
    excerpt: 'Assess your investment\'s health in seconds with the DSCR calculator.',
    author: 'LoopNet Team',
    category: 'Tools',
  ...
  {
    id: 'online-cre-auctions',
    title: 'Online Commercial Real Estate Auctions: Understanding and Succeeding',
    excerpt: 'Understanding, participating, and succeeding at CRE auctions in the digital age.',
    author: 'LoopNet Team',
    category: 'Auctions',
  ...
  {
    id: 'proof-of-funds-auctions',
    title: 'Understanding Proof of Funds for Online CRE Auctions',
    excerpt: 'Why proof of funds are important & how to provide yours for online commercial real estate auctions.',
    author: 'LoopNet Team',
    category: 'Auctions',
  ...
  {
    id: 'auction-glossary',
    title: 'Online CRE Auction Glossary: Common Terms & Phrases',
    excerpt: 'New to auctions? Learn these common terms & phrases to navigate online commercial real estate auctions.',
    author: 'LoopNet Team',
    category: 'Auctions',
  ...
  {
    id: 'buy-now-brokers-guide',
    title: 'Introducing Buy Now: A Guide for Brokers and Owners',
    excerpt: 'You could close deals even faster, with more control, and with greater certainty using buy now options.',
    author: 'LoopNet Team',
    category: 'Auctions',
  ...
  },
  {
    ...
    title: 'Introducing Buy Now: The Investors\' Guide',
    excerpt: 'Purchase properties quickly through streamlined transactions, with a transparent price upfront.',
    author: 'LoopNet Team',
    category: 'Auctions',
    date: 'August 30, 2022',
    readTime: '6 min read',
  ...
  },
  {
    ...
    title: 'Online Auctions for International Bidders',
    excerpt: 'How to participate in LoopNet auctions from outside the United States.',
    author: 'LoopNet Team',
    category: 'Auctions',
    date: 'August 15, 2022',
    readTime: '7 min read',
  ...
  {
    id: 'how-to-register-auction-bid',
    title: 'How to Register to Bid for Online Auction Properties',
    excerpt: 'Browse, bid, and buy CRE in LoopNet auctions by Ten-X with this step-by-step guide.',
    author: 'LoopNet Team',
    category: 'Auctions',
    date: 'July 30, 2022',
    readTime: '5 min read',
