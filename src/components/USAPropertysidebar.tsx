...
// ─── components/usa/Propertysidebar.tsx ──────────────────────────────────────
// Discovery sidebar for US property detail pages — related, popular,
// intelligence briefing, and advisory CTA.
    ...
    <aside className="space-y-0 w-full">
        ...
        >
          ...
          >
            ...
            <h3 className="font-serif text-[17px] text-[#2C2C2C] leading-tight">
              Related US Opportunities
            </h3>
            <p className="mt-1 text-[11px] text-[#8B8680] tracking-wide">
              Comparable mandates from our US portfolio
            </p>
          </div>
      ...
      >
        ...
        <p className="mt-3 text-[12px] leading-relaxed" style={{ color: '#9E9484', fontFamily: 'Georgia, serif' }}>
          Off-market multifamily deals, cap rate analysis, and US metro market reports — delivered weekly.
        </p>
        ...
        {subscribed ? (
          ...
          <form onSubmit={handleSubscribe} className="mt-5 space-y-2.5">
            ...
            >
              Subscribe to US Intelligence Brief
            </button>
          </form>
        )}
      </section>
      ...
      >
        ...
        <h3 className="font-serif text-[19px] text-[#2C2C2C] leading-snug">
          ...
          <em className="block font-light text-[#B8956B] text-[17px]">
            on this US opportunity
          </em>
        </h3>

        <p className="mt-3 text-[12px] text-[#8B8680] leading-relaxed" style={{ fontFamily: 'Georgia, serif' }}>
          Our US advisory team will provide a full briefing and arrange asset-level due diligence at your convenience.
        </p>
        ...
        <div className="space-y-2.5">
          ...
          {/* Secondary CTA */}
          <a
            href={`mailto:${brokerEmail}?subject=US Investment Inquiry`}
        ...
        >
          Murivest US Platform · Mandate-Based Advisory
        </p>
      </section>
