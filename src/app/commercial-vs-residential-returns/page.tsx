...
export const metadata: Metadata = {
  ...
  description: 'Analysis of why commercial real estate delivers superior returns compared to residential properties, with data on yields, risks, and institutional strategies.',
  ...
  openGraph: {
    title: 'Why Commercial Real Estate Outperforms Residential Investments',
    description: 'Analysis of why commercial real estate delivers superior returns compared to residential properties.',
    images: ['/image.png'],
  },
}
