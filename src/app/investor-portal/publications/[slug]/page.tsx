// src/app/investor-portal/publications/[slug]/page.tsx
  ...
  return (
    <div className="space-y-12">
      ...
      <div className="flex items-center gap-2 text-xs text-[#1B4332]/50">
        ...
        <Link href="/investor-portal/publications" className="hover:text-[#B8956B] transition-colors">Publications</Link>
        <ChevronRight className="h-3 w-3" />
      ...
      {displayPublication.relatedResearch && (
        <section>
          <div className="flex items-center justify-between mb-6">
            ...
            <Link 
              href="/investor-portal/publications"
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {(displayPublication.relatedResearch as RelatedResearch[]).map((related: RelatedResearch, index: number) => (
              <Link 
                key={index}
                href={`/investor-portal/publications/${related.id}`}
