...
import PersonalizedLuxuryGifts from '../components/sections/PersonalizedLuxuryGifts'
...
export const metadata: Metadata = {
  title: 'Institutional Real Estate Kenya | Commercial Investment Properties Nairobi | Murivest Realty Group',
