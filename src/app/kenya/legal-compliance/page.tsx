...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://murivest.com/legal-compliance' },
};
...
const jsonLd = {
  ...
  '@graph': [
    {
      '@type': 'WebPage',
      url: 'https://murivest.com/legal-compliance',
      ...
      breadcrumb: {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 2, name: 'Legal Framework', item: 'https://murivest.com/legal-compliance' },
        ],
      },
    },
    {
