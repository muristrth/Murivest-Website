// app/investor-portal/layout.tsx
'use client'
...
const navGroups = [
  {
    group: "Portfolio",
    items: [
      { href: '/investor-portal', label: 'Overview', icon: Home, mobileLabel: 'Overview' },
      { href: '/investor-portal/dashboard', label: 'Dashboard', icon: BarChart3, mobileLabel: 'Dashboard' },
      { href: '/investor-portal/orders', label: 'Orders', icon: Lock, securityLevel: 'high', mobileLabel: 'Orders' },
    ]
  },
  {
    group: "Insights",
    items: [
      { href: '/investor-portal/off-market', label: 'Off-market', icon: Briefcase, securityLevel: 'high', mobileLabel: 'Off-market' },
      { href: '/investor-portal/publications', label: 'Publications', icon: BookOpen, mobileLabel: 'Publications' },
    ]
  },
  {
    group: "Settings",
    items: [
      { href: '/investor-portal/payments', label: 'Payments', icon: MessageSquare, mobileLabel: 'Payments' },
      { href: '/investor-portal/profile', label: 'Profile', icon: User, mobileLabel: 'Profile' },
    ]
  }
];
...
export default function InvestorPortalLayout({
  ...
  const [activeTab, setActiveTab] = useState('/investor-portal')
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      if (securityContext.sessionExpiry && new Date() > securityContext.sessionExpiry) {
        ...
        window.location.href = '/investor-portal/login?expired=true'
      }
    }, 60000)
    ...
    >
      <div className="mx-auto max-w-[1600px] px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-14 lg:h-16">
          ...
          {/* Brand */}
          <Link href="/investor-portal" className="group flex items-center gap-2 lg:gap-3">
