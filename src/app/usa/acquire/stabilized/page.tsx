              ...
              {PROPERTY_TYPES.map((type) => {
                ...
                return (
                  <Link
                    ...
                    className="group flex items-center justify-between rounded-lg border border-[#E5E2DC] px-4 py-3 transition-all hover:border-[#8B7355]"
                  >
                    <span className="flex items-center gap-3">
                      <Icon size={18} className="text-[#8B7355]" />
                      <span className="font-medium text-[#2C2C2C] group-hover:text-[#8B7355] transition-colors">
                        {type.label}
                      </span>
                    </span>
                    <ArrowRight
