...
export const metadata: Metadata = {
  title: "Glossary — USA Commercial Real Estate Resources | Murivest",
  description:
    "Murivest CRE glossary defines key commercial real estate terms, metrics, and concepts for institutional investors and private capital.",
  alternates: { canonical: `https://${SITE.domain}/usa/resources/glossary"` },
};
