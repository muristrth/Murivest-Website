  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden bg-[#2C2C2C] py-24">
        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
          <div className="max-w-3xl">
            <Eyebrow className="text-[#8B7355]">Invest Platform</Eyebrow>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {[
              ...
              >
                ...
                <div className="mt-2 text-sm text-[#5A5A5A]">{item.label}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <Section className="py-20 bg-[#2C2C2C]">
        <div className="max-w-3xl">
          <Eyebrow className="text-[#8B7355]">Who We Serve</Eyebrow>
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-3">
          <div className="rounded-xl border border-[rgba(44,44,44,0.15)] bg-[#2C2C2C]/50 p-6">
