...
/* ─────────────────────────────────────────────────────────────
   MURIVEST — SINGAPORE / REVISED
   Palette enforced: Gold Brown #8B7355, Forest Green #1B4332, White
   Off-white #F8F7F4 is white-tint only. No #1F1E1C, #2C2C2C, #5A5A5A,
   no fake license numbers, no £XXm placeholders.
   ───────────────────────────────────────────────────────────── */

const SITE_URL = 'https://murivest.com';
const PAGE_PATH = '/singapore';

// Brand tokens - only these
const C = {
  forest: '#1B4332',
  forestDeep: '#122E22',
  offWhite: '#F8F7F4',
  ...
  return (
    <>
      ...
      <main className="bg-[#F8F7F4]">
        {/* Breadcrumb UI */}
        <nav aria-label="Breadcrumb" className="max-w- mx-auto px-6 md:px-12 lg:px-16 pt-6">
          <ol className="flex items-center gap-2 text- tracking-[0.14em] uppercase text-[#1B4332]/60">
            <li><Link href="/" className="hover:text-[#8B7355] transition-colors">Home</Link></li>
            <li aria-hidden="true" className="text-[#8B7355]/40">/</li>
            <li className="text-[#1B4332]" aria-current="page">Singapore</li>
          </ol>
        </nav>

        {/* HERO - Forest Deep, no black, no image LCP killer */}
        <section className="relative overflow-hidden bg-[#122E22] mt-6" aria-label="Singapore Commercial Real Estate Advisory">
          <div className="absolute inset-0 bg-gradient-to-br from-[#1B4332]/90 via-[#122E22] to-[#122E22]" />
          ...
          <div className="relative z-10 max-w- mx-auto px-6 md:px-12 lg:px-16 pt-28 pb-24">
            <div className="max-w-3xl">
              <div className="flex items-center gap-4 mb-8">
                <span className="w-8 h-px bg-[#8B7355]/60" />
                <p className="text- md:text- tracking-[0.35em] uppercase text-[#C2A272] font-medium">Singapore · Coverage Established 2026</p>
              </div>
              <h1 className="font-serif text-[2.4rem] md:text-[3.2rem] lg:text-[3.8rem] text-white leading-[1.05] mb-7">
                Institutional Commercial Real Estate Advisory, <em className="italic text-[#C2A272] font-light">Now in Singapore</em>
              </h1>
              <p className="text- md:text- text-white/75 leading-[1.7] font-light max-w-2xl mb-10">
              ...
              <div className="flex flex-wrap gap-4">
                <a href="#request-introduction" className="inline-flex items-center gap-3 px-7 py-3.5 bg-[#F8F7F4] text-[#1B4332] text- tracking-[0.2em] uppercase font-semibold hover:bg-[#8B7355] hover:text-white transition-colors duration-500">
                  Request an Introduction <ArrowUpRight className="w-3.5 h-3.5" strokeWidth={1.5} />
                </a>
                <a href="#coverage" className="inline-flex items-center gap-2 px-7 py-3.5 border border-[#8B7355]/40 text-white/80 text- tracking-[0.2em] uppercase font-medium hover:border-[#C2A272] hover:text-white transition-all duration-500">
        ...
        <section className="py-20 md:py-28 bg-white border-y border-[#8B7355]/15">
          <div className="max-w- mx-auto px-6 md:px-12 text-center">
            <p className="text- tracking-[0.25em] uppercase text-[#8B7355] mb-6">A Note on Where We Are</p>
            <p className="font-serif text-2xl md:text-3xl text-[#1B4332] leading-snug mb-6">We are a new entrant to the Singapore market.</p>
            <p className="text- text-[#1B4332]/70 leading-relaxed font-light max-w-2xl mx-auto">
        ...
        <section className="py-20 md:py-32 bg-[#1B4332] relative overflow-hidden">
          <div className="absolute inset-0 opacity-[0.03]" style={{ backgroundImage: 'radial-gradient(circle at 1px 1px, #C2A272 1px, transparent 0)', backgroundSize: '40px 40px' }} />
          <div className="relative z-10 max-w- mx-auto px-6 md:px-12 lg:px-16">
            <div className="text-center mb-16">
              <p className="text- tracking-[0.25em] uppercase text-[#C2A272] mb-4">Investment Thesis</p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              {THESIS_PILLARS.map((pillar) => {
                ...
                return (
                  <div key={pillar.title} className="border border-[#8B7355]/20 p-8 md:p-10 hover:border-[#C2A272]/40 transition-colors duration-500 bg-[#122E22]/40">
                    <div className="w-14 h-14 border border-[#8B7355]/30 flex items-center justify-center text-[#C2A272] mb-6"><Icon className="w-6 h-6" strokeWidth={1.25} /></div>
            ...
            <p className="text-center text- text-white/40 italic mt-12 max-w-xl mx-auto">Quantitative market data (vacancy, rents, yields) will be published once our Singapore research coverage is live and sourced. We will not publish placeholder figures.</p>
          </div>
        </section>

        {/* COVERAGE */}
        <section id="coverage" className="py-20 md:py-32 bg-white">
          <div className="max-w- mx-auto px-6 md:px-12 lg:px-16">
            <div className="text-center mb-16">
              <p className="text- tracking-[0.25em] uppercase text-[#8B7355] mb-4">Coverage</p>
              <h2 className="font-serif text-3xl md:text-4xl text-[#1B4332] mb-4">Districts We Are Building Coverage In</h2>
              <p className="text-sm text-[#1B4332]/60 max-w-xl mx-auto font-light">Focus areas as we establish the practice — not a claim of closed transactions in each district.</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {DISTRICTS.map((d) => (
                <div key={d.name} className="border border-[#8B7355]/15 p-6 hover:border-[#8B7355]/40 transition-colors duration-500 bg-[#F8F7F4]/60">
                  <div className="flex items-center gap-2 text-[#8B7355] mb-3"><MapPin className="w-3.5 h-3.5" strokeWidth={1.5} /><span className="text- tracking-[0.2em] uppercase">Focus Area</span></div>
                  <h3 className="font-serif text-lg text-[#1B4332] mb-1">{d.name}</h3>
                  <p className="text- text-[#1B4332]/60 font-light">{d.note}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="py-20 md:py-32 bg-[#F8F7F4] border-y border-[#8B7355]/10">
          <div className="max-w- mx-auto px-6 md:px-12 lg:px-16">
            <div className="text-center mb-16"><p className="text- tracking-[0.25em] uppercase text-[#8B7355] mb-4">Advisory Services</p><h2 className="font-serif text-3xl md:text-4xl text-[#1B4332]">What We Advise On</h2></div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {SERVICES.map((s) => (
                <div key={s.title} className="bg-white border border-[#8B7355]/15 p-8 hover:border-[#8B7355]/35 transition-colors duration-500">
                  <h3 className="font-serif text-xl text-[#1B4332] mb-3">{s.title}</h3>
                  <p className="text-sm text-[#1B4332]/65 leading-relaxed font-light">{s.body}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="py-16 bg-white">
          <div className="max-w- mx-auto px-6 md:px-12 lg:px-16 text-center border border-[#8B7355]/15 p-8 md:p-10 bg-[#F8F7F4]/40">
            <p className="text- tracking-[0.25em] uppercase text-[#8B7355] mb-3">Regulatory & Engagement</p>
            <p className="text- text-[#1B4332]/70 leading-relaxed font-light max-w-3xl mx-auto">
        ...
        <section className="py-20 md:py-32 bg-white">
          <div className="max-w- mx-auto px-6 md:px-12">
            <div className="text-center mb-16"><p className="text- tracking-[0.25em] uppercase text-[#8B7355] mb-4">Questions</p><h2 className="font-serif text-3xl md:text-4xl text-[#1B4332]">Frequently Asked</h2></div>
            <div className="divide-y divide-[#8B7355]/15">
              {[
                ...
                <div key={item.q} className="py-6">
                  <h3 className="text- font-medium text-[#1B4332] mb-2">{item.q}</h3>
                  <p className="text-sm text-[#1B4332]/65 leading-relaxed font-light">{item.a}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        {/* ENQUIRY */}
        <section id="request-introduction" className="py-20 md:py-32 bg-[#122E22]">
          <div className="max-w- mx-auto px-6 md:px-12 text-center">
            <div className="flex items-center gap-4 mb-8 justify-center"><div className="flex-1 h-px max-w- bg-[#8B7355]/30" /><span className="text- tracking-[0.3em] uppercase text-[#C2A272]">Confidential Enquiry</span><div className="flex-1 h-px max-w- bg-[#8B7355]/30" /></div>
            ...
            <form action={requestIntroduction} className="flex flex-col gap-3 max-w-md mx-auto">
              <input type="email" name="email" required placeholder="your@email.com" className="px-4 py-3.5 text- outline-none placeholder:text-white/30 bg-white/[0.06] border border-[#8B7355]/30 text-white focus:border-[#C2A272] transition-colors" />
              <input type="text" name="organization" placeholder="Organization (optional)" className="px-4 py-3.5 text- outline-none placeholder:text-white/30 bg-white/[0.06] border border-[#8B7355]/30 text-white focus:border-[#C2A272] transition-colors" />
              <button type="submit" className="px-8 py-3.5 text- font-semibold tracking-[0.18em] uppercase bg-[#F8F7F4] text-[#1B4332] hover:bg-[#8B7355] hover:text-white transition-colors">Submit Enquiry</button>
            </form>
            <div className="flex items-center justify-center gap-2 mt-6"><Shield className="w-3 h-3 text-[#8B7355]/60" strokeWidth={1.5} /><p className="text- text-white/40 tracking-wider">Your information is treated in strict confidence.</p></div>
          </div>
        </section>
      </main>
    </>
