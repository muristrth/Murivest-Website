...
// ──────────────────────────────────────────────────────────────
// MURIVEST SINGAPORE — COUNTRY SUB-HEADER
...
/* ═══════════════════════════════════════════════════════════════
   NAVIGATION CONFIGURATION — Singapore
   ═══════════════════════════════════════════════════════════════ */
...
const SINGAPORE_NAV: NavSection[] = [
  {
    label: 'Investments',
    description: 'Commercial real estate opportunities across Singapore',
    columns: [
      [
        { label: 'Property Listings', href: '/singapore/properties', sub: 'Grade A office, retail, shophouse', icon: Building2 },
        { label: 'Off-Market Opportunities', href: '/singapore/investor-portal', sub: 'Private treaty access', icon: Lock },
        { label: 'Strata Office', href: '/singapore/properties?assetType=strata-office', sub: 'Strata-titled investments' },
        { label: 'Shophouse', href: '/singapore/properties?assetType=shophouse', sub: 'Conservation assets' },
      ],
    ],
  },
  {
    label: 'Advisory',
    description: 'Institutional advisory services',
    columns: [
      [
        { label: 'Acquisition Advisory', href: '/singapore/services/acquisition-advisory', sub: 'Buy-side representation' },
        { label: 'Disposition Advisory', href: '/singapore/services/disposition-advisory', sub: 'Sell-side representation' },
        { label: 'Asset Management', href: '/singapore/services/asset-management', sub: 'Portfolio optimization' },
        { label: 'Portfolio Advisory', href: '/singapore/services/portfolio-advisory', sub: 'Strategic allocation' },
      ],
    ],
  },
  {
    ...
    columns: [
      [
        { label: 'Office', href: '/singapore/properties?assetType=grade-a-office', sub: 'Grade A & strata', icon: Building2 },
        { label: 'Retail', href: '/singapore/properties?assetType=retail', sub: 'Orchard & CBD retail', icon: Store },
        { label: 'Industrial', href: '/singapore/properties?assetType=industrial', sub: 'Logistics & warehousing', icon: Warehouse },
        { label: 'Shophouse', href: '/singapore/properties?assetType=shophouse', sub: 'Conservation assets', icon: Home },
        { label: 'Mixed-Use', href: '/singapore/properties?assetType=mixed-use', sub: 'Integrated developments', icon: LandPlot },
        { label: 'Hospitality', href: '/singapore/properties?assetType=hospitality', sub: 'Hotels & serviced apartments', icon: Hotel },
      ],
    ],
  },
  {
    ...
    columns: [
      [
        { label: 'Insights', href: '/singapore/insights', sub: 'Executive commentary' },
        { label: 'Market Reports', href: '/singapore/insights', sub: 'Quarterly publications' },
        { label: 'Cap Rate Analysis', href: '/singapore/singapore-market', sub: 'Return benchmarks' },
        { label: 'URA Master Plan', href: '/singapore/singapore-market', sub: 'Planning framework' },
        { label: 'S-REIT Analysis', href: '/singapore/insights', sub: 'SGX-listed vehicles' },
        { label: 'District Reports', href: '/singapore/singapore-market', sub: 'Area-by-area analysis' },
      ],
    ],
  },
  {
    label: 'Markets',
    description: 'Singapore district market coverage',
    columns: [
      [
        { label: 'Market Overview', href: '/singapore/singapore-market', sub: 'CBD & district analysis', icon: BarChart3 },
        { label: 'Marina Bay', href: '/singapore/singapore-market/marina-bay', sub: 'Trophy assets' },
        { label: 'Raffles Place', href: '/singapore/singapore-market/raffles-place', sub: 'Financial district' },
        { label: 'Tanjong Pagar', href: '/singapore/singapore-market/tanjong-pagar', sub: 'Rejuvenation pipeline' },
        { label: 'Jurong Lake', href: '/singapore/singapore-market/jurong-lake-district', sub: 'Second CBD' },
      ],
    ],
  },
  {
    label: 'About',
    description: 'Singapore advisory team and compliance',
    columns: [
      [
        { label: 'About Murivest Singapore', href: '/singapore/about', sub: 'Heritage & philosophy' },
        { label: 'Leadership', href: '/singapore/about', sub: 'Advisory team' },
        { label: 'Contact', href: '/singapore/contact', sub: 'Private office inquiry' },
        { label: 'Investor Portal', href: '/singapore/investor-portal', sub: 'Client access', icon: Lock },
      ],
    ],
  },
]
            ...
            >
              ...
              <div className="px-5 py-4 text-center border-t border-[#2D5A45]/8">
                <p className="text-[9px] tracking-[0.25em] uppercase text-[#8A8A8A]">
                  Marina Bay · Raffles Place · Orchard Road · Jurong Lake District
                </p>
              </div>
            </motion.div>
          </>
