        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-16">
          <div className="flex-1">
            <SectionHeader
              ...
              subtitle="Institutional-grade research and analysis from our Singapore advisory team."
            />
          </div>
          <Link
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {featured.map((article, i) => (
            <ScrollReveal key={article.id} delay={i * 0.1}>
              ...
              >
                {/* Image */}
                <div className="relative h-[200px] bg-[#1B4332] mb-6 overflow-hidden">
                  <div className="absolute inset-0 bg-gradient-to-t from-[#1B4332]/60 via-transparent to-transparent" />
                  <div className="absolute inset-0 flex items-center justify-center">
                    <span className="text-[9px] tracking-[0.3em] uppercase text-[#B8956B] font-medium">
                      {article.category}
                    </span>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  <h3 className="font-serif text-xl text-[#2C2C2C] group-hover:text-[#1B4332] transition-colors leading-snug">
                    {article.title}
                  </h3>
                  ...
                  <div className="flex items-center gap-4 pt-3">
                    <span className="text-[10px] tracking-[0.15em] uppercase text-[#B8956B]">
                      {article.author}
                    </span>
                    <span className="text-[#E8E6E1]">|</span>
                    <span className="text-[10px] text-[#8B8680] uppercase tracking-wider">
                      {article.date}
                    </span>
                    <span className="text-[#E8E6E1]">|</span>
                    <span className="flex items-center gap-1 text-[10px] text-[#8B8680]">
