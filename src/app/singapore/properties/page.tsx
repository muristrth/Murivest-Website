      ...
      <main>
        ...
        <section className="pt-32 pb-12 bg-[#2C2C2C]">
          <div className="max-w-[1400px] mx-auto px-6 md:px-12 lg:px-16">
            <ScrollReveal>
              <p className="text-[10px] tracking-[0.3em] uppercase text-[#8B7355] mb-4 font-medium">Institutional Portfolio</p>
              <h1 className="font-serif text-4xl md:text-5xl text-white leading-[1.05] mb-4">
                Singapore Commercial <span className="italic text-[#8B7355] font-light">Properties</span>
              </h1>
        ...
        {/* Filter bar */}
        <section className="sticky top-0 z-30 bg-white border-b border-[#E5E2DC] py-4">
          <div className="max-w-[1400px] mx-auto px-6 md:px-12 lg:px-16">
            <div className="flex flex-wrap items-center gap-3">
              <span className="text-[10px] tracking-[0.2em] uppercase text-[#5A5A5A] font-medium mr-2">Filter:</span>
              ...
              <div className="ml-auto text-[11px] text-[#5A5A5A]">
                Showing <span className="text-[#2C2C2C] font-medium">{SAMPLE_PROPERTIES.length}</span> properties
              </div>
            </div>
          </div>
        </section>
