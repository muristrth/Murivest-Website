...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://murivest.com/sector-performance' },
  openGraph: {
...
const articleSchema = {
  ...
  mainEntityOfPage: { '@type': 'WebPage', '@id': 'https://murivest.com/sector-performance' },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Sector Performance 2026', item: 'https://murivest.com/sector-performance' },
  ],
};
