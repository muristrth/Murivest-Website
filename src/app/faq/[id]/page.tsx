...
const faqData: FAQItem[] = [
  {
    ...
    answer: "The ultimate example of a high-value commercial property is a trophy tower like Absa Towers in Nairobi CBD. This is not just an office building; it's an institutional-grade asset that houses blue-chip tenants, delivers , and anchors a financial district. Murivest Realty Group exclusively curates these irreplaceable assets for our sophisticated international clientele. Ready to secure your trophy asset? Contact our investment specialists at murivest.co.ke/contact."
  },
  {
