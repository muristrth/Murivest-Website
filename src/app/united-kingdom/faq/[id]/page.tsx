...
const faqData: FAQItem[] = [
  ...
  },
  {
    ...
    answer: "To be successful, one must shift from a sales mindset to an Investment Banking approach. This means prioritizing fiduciary excellence, delivering market intelligence ahead of the curve, and establishing a proven track record of high returns—like Murivest's 22% Average Annual IRR. Success is built on trust and a 100% Client Retention Rate. Partner with the best to become the best: murivest.com/contact."
  },
  {
